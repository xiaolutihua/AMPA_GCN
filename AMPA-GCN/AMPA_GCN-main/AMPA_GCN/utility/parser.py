...
def parse_args():
    parser = argparse.ArgumentParser(description="Run AMPA_GCN.")
    ...
    parser.add_argument('--model_type', nargs='?', default='AMPA_GCN',
                        help='Specify the name of model (AMPA_GCN).')
    parser.add_argument('--adj_type', nargs='?', default='pre',
                        help='Specify the type of the adjacency (laplacian) matrix from {plain, norm, mean}.')
    parser.add_argument('--alg_type', nargs='?', default='AMPA_GCN',
                        help='Specify the type of the graph convolutional layer from {AMPA_GCN, LightGCN}.')
